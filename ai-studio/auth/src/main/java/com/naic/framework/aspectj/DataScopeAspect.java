package com.naic.framework.aspectj;
...
public class DataScopeAspect
{
    ...
    protected void handleDataScope(final JoinPoint joinPoint, DataScope controllerDataScope)
    {
        ...
        {
            List<SysUserRolePO> userRoleList=userRoleMapper.selectList(new QueryWrapper<SysUserRolePO>().eq("user_id",loginUser.getUserId()));
            List<SysRoleVO> roleList=new ArrayList<>();
            for (SysUserRolePO userRole:userRoleList){
                roleList.add(roleService.selectRoleById(userRole.getRoleId()));
            }
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUserVO user, String deptAlias, String userAlias, String permission)
    {
        ...
        if (StringUtils.isNotBlank(sqlString.toString()))
        {
            ...
            if (StringUtils.isNotNull(params) && params instanceof BaseEntityVO)
            {
                BaseEntityVO baseEntity = (BaseEntityVO) params;
