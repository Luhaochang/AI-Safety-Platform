            ...
            <el-row>
                ...
                <el-col :xs="24" :md="12" :style="{ height: '350px' }">
                    <div class="avatar-upload-preview">
                        <el-image :src="options.previews.url" :style="options.previews.img" />
                    </div>
                </el-col>
            </el-row>
            <br/>
...
import { Upload, Plus, Minus, RefreshLeft, RefreshRight, Camera } from "@element-plus/icons-vue";
...
function uploadImg() {
    proxy.$refs.cropper.getCropBlob(data => {
        ...
        uploadAvatar(formData).then(response => {
            ...
            updateUserProfile({avatar: response.data,userId: userStore.id}).then(res => {
                if (res.code === 200) {
