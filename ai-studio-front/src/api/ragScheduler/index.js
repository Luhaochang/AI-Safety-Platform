...
export const QWEN_MODELS = [
  { value: 'qwen3.7-max', label: 'Qwen3.7-Max', desc: '最新一代，最强性能（推荐）', maxTokens: 32000 },
  { value: 'qwen3.5-122b-a10b', label: 'Qwen3.5-122B', desc: 'Strongest reasoning (recommended)', maxTokens: 32000 },
  { value: 'qwen3-235b-a22b', label: 'Qwen3-235B', desc: '最强推理（推荐）', maxTokens: 32000 },
  { value: 'qwen-turbo', label: 'Qwen-Turbo', desc: '快速响应，适合简单对话', maxTokens: 8000 },
  { value: 'qwen-plus', label: 'Qwen-Plus', desc: '平衡性能和成本', maxTokens: 32000 },
...
export async function callQwenApi(query, historyMessages = [], modelName = 'qwen3.7-max') {
